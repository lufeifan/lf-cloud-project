<template>
    <div class="mod-config">
        ...
        <el-table :data="dataList" size="mini" border v-loading="dataListLoading" @selection-change="selectionChangeHandle"
                  style="width: 100%;">
...
<script>
    ...
    import AddOrUpdate from './${className?uncap_first}-add-or-update'
    ...
    export default {
        ...
        methods: {
            ...
            getDataList() {
                ...
                list({ limit: this.pageSize, page: this.pageIndex })
                    .then(({data}) => {
